$baseDir = "d:\antigravity website\wristmechanic"

Write-Host "=========================================" -ForegroundColor Cyan
Write-Host "    WRISTMECHANIC - AUDIT REPORT         " -ForegroundColor Cyan
Write-Host "=========================================" -ForegroundColor Cyan
...
if ($indexContent -match "blog-horo-card" -or $indexContent -match "blog-horo-grid") {
...
Write-Host "`nWristMechanic Audit Completed Successfully." -ForegroundColor Cyan
